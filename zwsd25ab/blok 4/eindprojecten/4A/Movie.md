...
- Alle films worden in één tabel vastgelegd `movies`. Dit is één tabel met alle films die bekend zijn. 
- Een film kan maar 1 keer voorkomen (uniek). 
...
#### Backend
4. Als bezoeker wil ik kunnen zoeken door de database naar films.
