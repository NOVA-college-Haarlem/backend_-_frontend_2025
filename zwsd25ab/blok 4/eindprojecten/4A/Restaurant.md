...
- Alle gerechten worden in één tabel vastgelegd dishes. Dit is één tabel met alle gerechten die bekend zijn. 
- Een gerecht kan maar 1 keer voorkomen (uniek).
...
#### Backend
4. Als bezoeker wil ik kunnen zoeken door de database naar gerechten.
