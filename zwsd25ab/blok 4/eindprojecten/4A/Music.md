...
- Alle albums worden in één tabel vastgelegd albums. Dit is één tabel met alle albums die bekend zijn. 
- Een album kan maar 1 keer voorkomen (uniek). 
...
#### Backend
4. Als bezoeker wil ik kunnen zoeken door de database naar albums.
